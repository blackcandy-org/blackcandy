...
class MediaFileTest < ActiveSupport::TestCase
  test 'should get file path array from media_path' do
    expect_file_paths = [
      ...
      '/app/test/fixtures/files/artist2_album1.ogg',
      '/app/test/fixtures/files/artist1_album2.mp3',
      '/app/test/fixtures/files/artist2_album1.wav',
  ...
  test 'should get correct format' do
    ...
    assert_equal 'ogg', MediaFile.format(file_fixture('artist2_album1.ogg'))
    assert_equal 'wav', MediaFile.format(file_fixture('artist2_album1.wav'))
  ...
  test 'should get image from media file' do
    ...
    %w(artist1_album2.mp3 artist1_album1.m4a artist1_album1.flac artist2_album1.wav).each do |file|
  ...
  test 'should get tag info from ogg file' do
    tag_info = MediaFile.send(:get_tag_info, file_fixture('artist2_album1.ogg'))
  ...
  test 'should get tag info from wav file' do
    tag_info = MediaFile.send(:get_tag_info, file_fixture('artist2_album1.wav'))
