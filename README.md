...
| TRANSCODER_CACHE_SIZE        | 10240     | Maximum size in MB of the transcoded audio cache before least recently used entries are removed.                                                                                                                                                                                          |
| TRANSCODER_CACHE_PATH        |           | Directory for transcoded audio. Defaults to a cache directory inside the app. Useful when you want the cache on a larger or faster disk.                                                                                                                                                  |
| TRANSCODER_MAX_CONCURRENCY   | CPU count | Maximum number of transcoding processes that may run at once, counted separately for tracks being added to the cache and for tracks being seeked within.                                                                                                                                  |
